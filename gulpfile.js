...
var paths = {
  ...
  pugIndex: ['./assets/index.pug'],
  pug: ['./assets/**/*.pug', './app/**/*.pug', './modules/**/*.pug'],
...
gulp.task('index', function () {
  gulp.src(paths.pugIndex)
  .pipe(connect.reload())
  .pipe(plumber({ errorHandler: onError }))
  .pipe(pugGulp({pretty: false, pug: pug}))
...
gulp.task('watch:index', function () {
  gulp.watch(paths.pugIndex, ['index']);
});
...
gulp.task('watch', ['watch:icon-fonts', 'watch:index', 'watch:pug', 'watch:scripts', 'watch:sassModules', 'watch:sass']);
 ...
 * Default task
 */
gulp.task('buildAssets', ['images', 'icon-fonts', 'index', 'pug', 'vendorJs', 'vendorCss', 'scripts', 'sassModules', 'sass']);
